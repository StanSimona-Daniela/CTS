...
public class Rezervare {
    ...
    public Rezervare(int codRezervare, boolean areMancareInclusa, boolean areScaunErgonomic, boolean areBauturiRacoritoare, boolean areMuzicaAmbientalaPersonalizata, String genMuzical) {
